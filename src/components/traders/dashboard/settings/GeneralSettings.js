...
import { getData, validatePhoneNumber, generalSettings } from "../../TraderFunctions";
            ...
            await getData(request).then(response => {
                if (response.Message === "Trader found.") {
                    ...
                    this.setState({
                        ...
                        OldPhoneNumber: trader.PhoneNumber,
    ...
    validateField(field, value) {
        ...
        switch (field) {
            ...
            case "DateOfBirth":
                ...
                Errors.DateOfBirth = Dictionary.DateOfBirthError1;
                ...
                Errors.DateOfBirth = Dictionary.DateOfBirthError2;
                break;
            case "PhoneNumber":
